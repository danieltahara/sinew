...
const NoBench_NestedObj& NoBench_NestedObj::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_nobench_2eproto();  return *default_instance_;
}
      ...
      case 10: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_nested_arr_str:
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8String(
            this->nested_arr_str(0).data(), this->nested_arr_str(0).length(),
            ::google::protobuf::internal::WireFormat::PARSE);
        } else {
          goto handle_uninterpreted;
        }
      ...
      case 12: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_sparse_str:
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8String(
            this->sparse_str(0).data(), this->sparse_str(0).length(),
            ::google::protobuf::internal::WireFormat::PARSE);
        } else {
          goto handle_uninterpreted;
        }
